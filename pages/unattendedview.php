...
<html>
    <head>
        ...
        <style>
            #footer {position: fixed;padding: 10px 10px 0px 10px;bottom: 0;width: 100%;
                /* Height of the footer*/height: 50px;}
        </style>
        <style>
            table {
            border-collapse: collapse;width: 100%;color: ##033E3E;
            font-family: monospace;font-size: 30px;text-align: left;}
    ...
    <body style="background-color: #E0FFFF">
        ...
        <center><h1 style="color: blue;font-size:xx-large">UNATTENDED CALLS</h1></center>
        <form method="POST">
            <table id="customers">
                <tr>
                    <th>ID</th>
                ...
                <?php
                        ...
                        $sql = "SELECT id,client,complaint,date,location,status  FROM calls  WHERE status='new'";
                ...
                <br>
                <center>
                <input type="submit" name="submit" value="Accept checked calls">
                </center>
	    </form>
        ...
        <?php
			...
			if (isset($_POST['submit'])){
                ...
                echo "<h4 style=\"color: blue;font-size:x-large\">Recently accepted calls:</h4>";
                echo "</div>";
				foreach ($_POST['id'] as $id):
                    ...
                    $sql = mysqli_query($conn, "update `calls` set status='pending' where id='$id'");
                    echo "<div style=\"text-align:center\">";
        ...
        <h3><a style="color: blue;font-size:large;" href= "http://localhost/ELECTRONIX/electronixselect.php">Back</a></h3>
